...
namespace Tsapi
{
    public static partial class Csta
    {
        ...
        public struct Connection_t
        {
            ...
            public SubjectDeviceID_t staticDevice;
        }
        ...
        {
            public int count;
            public IntPtr connection; //pointer to Connection_t[]
        ...
        public struct CSTAMonitorCrossRefID_t
        {
            ...
            public CSTAMonitorCrossRefID_t(int value)
            {
		...
		public struct CSTASetAgentState_t
        {
			...
			public AgentGroup_t agentGroup;
        ...
        public struct CSTAConferencedEvent_t
        {
			...
			public SubjectDeviceID_t confController;
			public SubjectDeviceID_t addedParty;
        ...
        public struct CSTAConnectionClearedEvent_t
        {
			...
			public SubjectDeviceID_t releasingDevice;
			public LocalConnectionState_t localConnectionInfo;
			public CSTAEventCause_t cause;
        }
        ...
        public struct CSTADeliveredEvent_t
        {
			...
			public SubjectDeviceID_t alertingDevice;
			public CallingDeviceID_t callingDevice;
			public CalledDeviceID_t calledDevice;
			public RedirectionDeviceID_t lastRedirectionDevice;
			public LocalConnectionState_t localConnectionInfo;
			public CSTAEventCause_t cause;
        }
        ...
        {
			public ConnectionID_t connection;
			public SubjectDeviceID_t divertingDevice;
			public CalledDeviceID_t newDestination;
			public LocalConnectionState_t localConnectionInfo;
			public CSTAEventCause_t cause;
        }
        ...
        public struct CSTAEstablishedEvent_t
        {
			...
			public SubjectDeviceID_t answeringDevice;
			public CallingDeviceID_t callingDevice;
			public CalledDeviceID_t calledDevice;
			public RedirectionDeviceID_t lastRedirectionDevice;
			public LocalConnectionState_t localConnectionInfo;
        ...
        public struct CSTAFailedEvent_t
        {
			...
			public SubjectDeviceID_t failingDevice;
			public CalledDeviceID_t calledDevice;
			public LocalConnectionState_t localConnectionInfo;
			public CSTAEventCause_t cause;
        }
        ...
        public struct CSTAHeldEvent_t
        {
			...
			public SubjectDeviceID_t holdingDevice;
			public LocalConnectionState_t localConnectionInfo;
			public CSTAEventCause_t cause;
        }
        ...
        {
			public ConnectionID_t connection;
			public SubjectDeviceID_t trunkUsed;
			public CalledDeviceID_t calledDevice;
			public LocalConnectionState_t localConnectionInfo;
			public CSTAEventCause_t cause;
        }
        ...
        public struct CSTAOriginatedEvent_t
        {
			...
			public SubjectDeviceID_t callingDevice;
			public CalledDeviceID_t calledDevice;
			public LocalConnectionState_t localConnectionInfo;
			public CSTAEventCause_t cause;
        }
